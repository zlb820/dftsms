...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`dftsms` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `t_account_modify` (
  ...
  CONSTRAINT `FK_t_account_modify_role` FOREIGN KEY (`mod_role`) REFERENCES `t_role` (`pk_role_id`),
  CONSTRAINT `FK_t_account` FOREIGN KEY (`mod_id`) REFERENCES `t_customer` (`pk_cus_id`)
...
CREATE TABLE `t_business` (
  ...
  `bus_pic` char(16) DEFAULT NULL,
  `bus_status` tinyint(4) NOT NULL,
  PRIMARY KEY (`pk_bus_id`),
  KEY `FK_t_business` (`bus_pic`),
  CONSTRAINT `FK_t_business` FOREIGN KEY (`bus_pic`) REFERENCES `t_pictures` (`pk_pic_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_store` (
  ...
  `sto_pic` char(1) DEFAULT NULL,
  `sto_status` tinyint(1) NOT NULL,
  `sto_score` char(10) NOT NULL,
  `fk_address` char(1) DEFAULT NULL,
  PRIMARY KEY (`fk_sto_id`),
  KEY `FK_t_store_pic` (`sto_pic`),
  CONSTRAINT `FK_t_store_pic` FOREIGN KEY (`sto_pic`) REFERENCES `t_pictures` (`pk_pic_id`),
